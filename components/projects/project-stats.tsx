...
export function ProjectStats({ 
  ...
  const stats = useMemo(() => {
    if (totalNumberOfPrograms !== undefined && 
  ...
  }, [projects, totalNumberOfPrograms, numberOfActivePrograms, totalBudget, totalNumberOfBeneficiaries])
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats.budget.toLocaleString("en-US")} ريال</div>
        </CardContent>
      </Card>
