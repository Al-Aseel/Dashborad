...
<SingleImageUpload
  ...
  onFileIdChange={(fileId) =>
    setFormData((prev) => ({ ...prev, logoFileId: fileId || "" }))
  }
...
- timeout مخصص لرفع الملفات: 60 ثانية
- timeout عام للـ API: 30 ثانية
- timeout للشركاء: 45 ثانية
- timeout لرفع صور المعرض: 90 ثانية
