...
```
https://dashboard.elaseel.org/api/v1/user/reset-password?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
```
...
- Link points to: `/api/v1/user/reset-password?token=<JWT_TOKEN>`

### 2. API Route Processing (`/api/v1/user/reset-password`)
...
2. Navigate to: `https://dashboard.elaseel.org/api/v1/user/reset-password?token=<TOKEN>`
